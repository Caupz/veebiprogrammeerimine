...
require('../tund4/functions.php');
    ...
    if(isset($_POST['submitUserData']) && $_POST['submitUserData']) {
        ...
        if($fields['password'] != $fields['passwordConfirm']) $errors['password'] = "Paroolid ei klapi.";
        if(strlen($fields['password']) < 8) $errors['password'] = "Parool ei tohi olla alla 8 tähemärgi.";
